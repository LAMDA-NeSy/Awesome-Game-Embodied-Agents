...
Paper ratings use a small Cloudflare Worker with Durable Object storage. A visitor can keep one current 1–5 rating per paper and browser. Updating a rating replaces that browser's previous vote, and the website displays the live average and vote count.
