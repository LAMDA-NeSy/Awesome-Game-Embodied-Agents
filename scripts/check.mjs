...
for(const p of ['dist/assets/app.js','dist/assets/catalog.mjs','dist/assets/updates.mjs','dist/assets/style.css','dist/README.md','dist/CITATION.cff','dist/CONTRIBUTING.md','dist/docs/collection-policy.md','dist/docs/metadata.md','dist/docs/assets/future-vision.png','dist/selection-audit.json','dist/maintenance.json','dist/updates.json','dist/CHANGELOG.md'])await fs.access(p);
...
for(const heading of ['## Welcome','## Our vision','## Getting started'])assert(generatedReadme.includes(heading),`README missing ${heading}`);
